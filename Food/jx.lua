    ...
    packages = {
        {
            ...
            sha256 = "53d7335c94330580e909023582839554db5c05745014771f8319eef2bdf87bad",
            resources = {
                {
                    path = name,
        ...
        },
        {
            ...
            sha256 = "d9b53bade9981e331894a2df42789142181f9fd4e9dc69cb410a3df62679605f",
            resources = {
                {
                    path = name,
                    installpath = "bin/" .. name,
        ...
        },
        {
            ...
            sha256 = "8a7e13f0982471310c321762421f5bc5197473f28114bf340383920b7e8280e2",
            resources = {
                {
                    path = name .. ".exe",

    ...
    packages = {
        {
            ...
            sha256 = "fa3f1f39d016d6a7ae216bc0542e838e2da002f7c1f157e93dc10412790dc371",
            resources = {
                {
                    path = name,
        ...
        },
        {
            ...
            sha256 = "2188137ada09bcd0b9afaf3d8579dd9da0ea9850af83e8a8630048df82a9c465",
            resources = {
                {
                    path = name,
                    installpath = "bin/" .. name,
        ...
        },
        {
            ...
            sha256 = "a568fa48f6aef46ab10ae7ee7d5eebacfdf98601ec978bd401e8f21f64919c1e",
            resources = {
                {
                    path = name .. ".exe",

    ...
    packages = {
        {
            ...
            sha256 = "efcac323dd021f3973dc7450928229abb4d4085e2c053080bdd7a70ddb944158",
            resources = {
                {
                    path = name,
        ...
        },
        {
            ...
            sha256 = "53e5de72255088b8daa0eeff1b7f6ea47a5210335c28d9a30be239d34941a8dd",
            resources = {
                {
                    path = name,
                    installpath = "bin/" .. name,
        ...
        },
        {
            ...
            sha256 = "13b0b6cb58c6594bb5799f6838fed62300617b699e073553b20b4ffc7a88f416",
            resources = {
                {
                    path = name .. ".exe",

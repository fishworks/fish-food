    ...
    packages = {
        {
            os = "darwin",
            arch = "amd64",
            url = githubReleaseDownloadURL .. "/v" .. version .. "/" .. "darwin-amd64-" .. name,
        ...
        },
        {
            os = "linux",
            arch = "amd64",
            url = githubReleaseDownloadURL .. "/v" .. version .. "/" .. "linux-amd64-" .. name,
        ...
        },
        {
            os = "windows",
            arch = "amd64",
            url = githubReleaseDownloadURL .. "/v" .. version .. "/" .. "windows-amd64-" .. name .. ".exe",

...
food = {
    ...
    packages = {
        ...
        },
        {
            os = "linux",
            arch = "386",
            url = "https://downloads.haskell.org/~cabal/cabal-install-latest/cabal-install-" .. version .. "-i386-unknown-linux.tar.xz",
        ...
        },
        {
            os = "windows",
            arch = "386",
            url = "https://downloads.haskell.org/~cabal/cabal-install-latest/cabal-install-" .. version .. "-i386-unknown-mingw32.zip",

...
food = {
    ...
    packages = {
        ...
        },
        {
            ...
            -- shasum of the release archive
            sha256 = "bd52f832cdff1d8fc6f4febcdc1c262640c7fa49f07bbb1a53ed6a7ea3b31ef7",
            resources = {
                {
                    path = name .. "-linux-x64",
                    installpath = "bin/" .. name,
        ...
        },
        {
            ...
            -- shasum of the release archive
            sha256 = "618178acb26e0bad9eb8d0ffc1ce941fb74d45fd49cabc6f51a1a30a0a041d41",
            resources = {
                {

    ...
    packages = {
        {
            ...
            sha256 = "152c42fb390110e35dcda895aa9974070ebba9819d450fe9a15312c621b88203",
            resources = {
                {
                    path = name,
        ...
        },
        {
            ...
            sha256 = "e77aafdb1b9c7442a5c4dd32c03443d8ac578cc838704b975686ec0d87797907",
            resources = {
                {
                    path = name,
                    installpath = "bin/" .. name,
        ...
        },
        {
            ...
            sha256 = "63a88e7fc47acf45da2caa2629a9b2294dec5aefa8c2edd1292de915a870b857",
            resources = {
                {
                    path = name .. ".exe",

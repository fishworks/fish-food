    ...
    packages = {
        {
            os = "darwin",
            arch = "amd64",
            url = "https://gofi.sh/releases/fish-v" .. version .. "-darwin-amd64.tar.gz",
        ...
        },
        {
            os = "linux",
            arch = "amd64",
            url = "https://gofi.sh/releases/fish-v" .. version .. "-linux-amd64.tar.gz",
        ...
        },
        {
            os = "windows",
            arch = "amd64",
            url = "https://gofi.sh/releases/fish-v" .. version .. "-windows-amd64.tar.gz",
